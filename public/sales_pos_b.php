...
<section id="main">
    ...
    <div class="container-sm form-group border p-3  justify-content-center border-dark rounded" id="empdetailscontainer" style="background-color: #EDE1CF;">
        <div class="row my-2">
            <div class="col-lg-4">
                <h3 style= "font-weight: bold;"><i class="bi bi-receipt"></i> Sales Summary of POS B</h3>
            </div>
        </div>
        <form action="includes/search_code.php" method="POST">
            <div class="row g-1 align-items-center justify-content-end">
                ...
                <div class="col-auto">
                    <button type="submit" id="search_pos_b" name="search_pos_b" class="btn-sm btn-danger"><i class="bi bi-search"></i></button>
                </div>
            </div>
        </form>
                            ...
                            if (isset($_GET['salesnum'])) {
                                ...
                                if (mysqli_num_rows($run_query) > 0){
                                    while ($row = mysqli_fetch_array($run_query)){
                                        ...
                                        $total_discount_given = $row['TotalDiscountGiven'];
                                        $total_discounted_amount = $row['TotalDiscountedAmount'];
                                        ...
                                        echo '<td>'.$total_discount_given.'</td>';
                                        echo '<td>'.$total_discounted_amount.'</td>';
