...
<div class="container-sm form-group border p-3  justify-content-center border-dark  rounded" id="empdetailscontainer" style="background-color: #EDE1CF;">
    ...
    <div class="row my-2">
      <div class="col-lg-4">
          <h2 style= "font-weight: bold;"><i class="bi bi-credit-card-2-front"></i> Employee Payroll Report</h2>
      </div>
    </div>
    <form action="includes/search_code.php" method="POST">
      <div class="row g-1 align-items-center justify-content-end">
          ...
          <div class="col-auto">
              <button type="submit" id="search_payroll_report" name="search_payroll_report" class="btn btn-sm btn-danger"><i class="bi bi-search"></i></button>
          </div>
      </div>
    </form>
